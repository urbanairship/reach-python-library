...
project = u'Airship Wallet Python Library'
copyright = u'%d, Airship' % year
...
version = __about__["__version__"].strip().rstrip('b').rstrip('a')
# The full version, including alpha/beta/rc tags.
release = __about__["__version__"].strip()
